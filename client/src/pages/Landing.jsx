...
const UploadCVIllustration = () => (
  ...
  >
    ...
    {[0, 1, 2].map((i) => (
      <path
        key={i}
        d={`M ${80 + i * 14} ${170 - i * 8} L ${100 + i * 14} ${150 - i * 8}`}
        stroke="#534ab7"
        strokeWidth="1.5"
        strokeLinecap="round"
        opacity={0.3 + i * 0.25}
    ...
    <circle
      ...
      strokeWidth="6"
      fill="none"
      strokeDasharray="175 76"
      strokeLinecap="round"
      transform="rotate(-90 348 100)"
    />
    <text
      x="348"
      y="96"
    ...
    {[
      ...
      <g key={chip.label}>
        <rect
          x={chip.x}
          y={chip.y}
          width={chip.label.length * 5.5 + 16}
          height="18"
          rx="9"
          fill={`${chip.color}18`}
          stroke={`${chip.color}50`}
          strokeWidth="1"
        />
        <text
          x={chip.x + chip.label.length * 2.75 + 8}
          y={chip.y + 13}
          fontSize="8.5"
          fontWeight="600"
          fill={chip.color}
...
const DecodeJobIllustration = () => (
  ...
  >
    ...
    {[
      ...
      <g key={i}>
        ...
        <rect
          ...
          height="5"
          rx="2.5"
          fill={line.highlight ? line.color : "#e5e7eb"}
          opacity={line.highlight ? 0.9 : 1}
        />
      </g>
    ))}
    {/* Scan line animation */}
    ...
    {[
      ...
      <g key={chip.label}>
        <rect
          x={chip.x}
          y={chip.y}
          width={chip.label.length * 5.6 + 10}
          height="15"
          rx="7.5"
          fill={`${chip.color}18`}
          stroke={`${chip.color}40`}
          strokeWidth="1"
        />
        <text
          x={chip.x + chip.label.length * 2.8 + 5}
          y={chip.y + 10.5}
          fontSize="8"
          fontWeight="600"
          fill={chip.color}
    ...
    <text
      ...
      fontFamily="system-ui, sans-serif"
    >
      Fast-paced · data-driven · ownership
    </text>
    {/* Connecting dashes */}
    <path
      d="M228 148 L244 148"
...
const TailorApplyIllustration = () => (
  ...
  >
    ...
    <path
      d="M396 268 L398 262 L400 268 L394 270 Z"
      fill="#534ab7"
      opacity="0.5"
    />
  ...
  const nodes = [
    {
      ...
      sub: "Day 1",
      color: "#534ab7",
      shadow: "rgba(83,74,183,0.16)",
      emoji: "📄",
    },
    {
      x: 148,
      y: 236,
      label: "Decoded 3 jobs",
      sub: "Day 2",
      color: "#7f77dd",
      shadow: "rgba(127,119,221,0.16)",
      emoji: "🔍",
    },
    {
      x: 236,
    ...
    },
    {
      ...
      sub: "Day 6",
      color: "#ef9f27",
      shadow: "rgba(239,159,39,0.16)",
      emoji: "🎉",
    },
  ];
  const topStats = [
    { x: 14, label: "AI-powered", val: "Gemini 2.5", color: "#534ab7" },
    { x: 162, label: "Countries", val: "40+", color: "#1d9e75" },
  ];
  return (
    <svg
      viewBox="0 0 440 360"
    ...
    >
      <defs>
        <linearGradient id="bgAbout" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#ddf7f0" />
        </linearGradient>
        <linearGradient id="pathGlow" x1="0%" y1="100%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#534ab7" stopOpacity="0.18" />
          <stop offset="100%" stopColor="#1d9e75" stopOpacity="0.18" />
        </linearGradient>
        <linearGradient id="pathLine" x1="0%" y1="100%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#534ab7" />
          <stop offset="100%" stopColor="#1d9e75" />
        </linearGradient>
      </defs>
      ...
      {/* Path glow ribbon */}
      <path
        d="M60 310 C85 282 112 258 148 236 C186 212 212 190 236 166 C264 138 290 115 316 100 C344 82 366 69 385 58"
        stroke="url(#pathGlow)"
        strokeWidth="46"
        strokeLinecap="round"
        fill="none"
      ...
      {nodes.map((node) => (
        <g key={node.label}>
          {/* Outer glow halo */}
          <circle cx={node.x} cy={node.y} r="32" fill={node.shadow} />
          {/* Filled node */}
          <circle cx={node.x} cy={node.y} r="21" fill={node.color} />
          <circle
            cx={node.x}
            cy={node.y}
            r="21"
      ...
      {/* Corner decorations */}
      <circle cx="420" cy="342" r="10" fill="rgba(83,74,183,0.12)" />
      <circle cx="16" cy="342" r="6" fill="rgba(29,158,117,0.18)" />
      <circle cx="420" cy="200" r="4" fill="rgba(239,159,39,0.22)" />
    </svg>
  );
};
...
const CompanyTicker = () => {
  ...
  return (
    <section className="pt-10 pb-16 bg-white border-b border-gray-100 overflow-hidden">
  ...
  const stats = [
    {
      ...
      icon: "🎯",
      tip: "Across all users after CV tailoring",
    ...
    },
    {
      ...
      icon: "📈",
      tip: "Vs. generic CV applications",
    ...
    {
      value: "5 min",
      label: "Average per application",
      icon: "⚡",
      tip: "From job target to tailored PDF",
    ...
    },
    {
      ...
      icon: "🚀",
      tip: "And counting — new signups every day",
        ...
        <div ref={ref} className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {stats.map((s, i) => (
            <Tooltip key={s.label} text={s.tip} position="top">
              <div
                className={`relative overflow-hidden group text-center px-6 pt-8 pb-7 rounded-3xl bg-white border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-default w-full ${
                  visible
              ...
              >
                {/* Top accent bar */}
                <div
                  className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${s.accent} rounded-t-3xl`}
                />
                {/* Icon container */}
                <div
                  className={`w-14 h-14 mx-auto mb-5 rounded-2xl ${s.iconBg} flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300`}
                >
                  {s.icon}
                </div>
                <p
                  className={`text-4xl font-bold mb-1.5 tracking-tight ${s.valueColor}`}
                >
                  {s.value}
                </p>
    ...
    <section id="about" className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <div
              className={`relative rounded-3xl overflow-hidden shadow-2xl transition-all duration-700 ${visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}
            >
              <AboutIllustration />
            </div>
            {/* Floating badge */}
            <div
              className={`absolute -top-5 -right-5 bg-brand-600 text-white rounded-2xl px-5 py-4 shadow-2xl transition-all duration-700 delay-300 ${visible ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}
            >
            ...
            {/* Powered badge */}
            <div
              className={`absolute -bottom-4 left-8 bg-white rounded-2xl shadow-xl px-5 py-3.5 border border-gray-100 transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            >
          ...
          {/* Copy */}
          <div
            className={`order-1 lg:order-2 transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900  mb-6">
              We built the tool
              <span className="gradient-text"> we wish existed </span>
              when job hunting.
            </h2>
            <p className="text-gray-500 text-base text-justify">
              Seevv was born from frustration; hours spent tweaking CVs,
              guessing what recruiters want, and writing generic cover letters
              that went nowhere. We built an AI platform that actually decodes
              what companies need and helps you present yourself perfectly.
            </p>
            <p className="text-gray-500 text-base leading-relaxed mb-10 text-justify">
              Every feature, from the Deep Decoder to voice-matched cover
              letters is designed to give you a genuine advantage in a
              competitive market. Not by gaming the system, but by being
              precisely, authentically relevant.
            </p>
              ...
              {[
                {
                  label: "Founded",
                  value: "2026",
                  tip: "Born from frustration, built with purpose",
                },
                {
                  label: "Interview rate",
                  value: "3× more",
                  tip: "Compared to unoptimised CVs",
                },
              ].map((item) => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            A complete system from decoding what companies need to handing you a
            polished, tailored application ready to submit.
          </p>
        </div>
        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-6">
          {services.map((s, i) => (
            <Tooltip key={s.title} text={s.tip} position="top">
              ...
              >
                <div
                  className={`w-14 h-14 ${s.bg} ${s.color} rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300`}
                >
                  {s.icon}
                </div>
...
const StepItem = ({ step, index, colorMap }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          <Tooltip text={step.tip} position="right">
            <div
              className={`w-12 h-12 ${c.badge} rounded-2xl flex items-center justify-center shadow-lg cursor-default`}
            >
      ...
      >
        <div
          className={`relative rounded-3xl overflow-hidden ${c.bg} p-6 shadow-xl ring-1 ${c.ring}`}
        >
          {step.illustration}
        </div>
        <div
          className={`absolute -bottom-5 ${i % 2 === 0 ? "-right-5" : "-left-5"} w-24 h-24 rounded-3xl ${c.bg} border-2 border-white opacity-70 -z-10`}
        />
        <div
          className={`absolute -top-4 ${i % 2 === 0 ? "-left-4" : "-right-4"} w-14 h-14 rounded-2xl ${c.dot} opacity-15 -z-10`}
        />
      </div>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            Designed for speed without sacrificing quality. Most users go from
            upload to tailored application in under 10 minutes.
          </p>
        </div>
...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    {
      quote:
        "I applied to 12 jobs before Seevv. Then I used it for the 13th (Stripe). Got the interview within 48 hours. The match score told me exactly what to emphasise.",
      name: "Adaeze O.",
    ...
    {
      quote:
        "The Deep Decoder is genuinely scary good. It told me things about the job posting I hadn't even noticed. My CV went from 54% to 89% match after the rewrite.",
      name: "James K.",
    ...
    {
      quote:
        "The cover letter literally sounds like me. I uploaded a sample of my writing and the AI nailed my voice. My recruiter asked if I'd written it myself, I said yes.",
      name: "Miriam S.",
  ...
  return (
    <section
      className="py-28 bg-brand-600 relative overflow-hidden"
      ref={sectionRef}
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-brand-200 text-lg max-w-xl mx-auto">
            Don't take our word for it. Here's what job seekers say after
            landing their roles with Seevv.
          </p>
        </div>
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Unlimited Decoder analyses",
        "Unlimited cover letters",
        "Voice mirroring AI",
        "Priority AI generation",
        "PDF export — all styles",
        "Email support",
      ],
      missing: [],
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto mb-10">
            Start free. Upgrade when you're ready. No hidden fees, no CV held
            hostage.
          </p>
          {/* Toggle */}
          <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-xl p-1 shadow-sm">
            ...
            >
              Annual
              <span className="text-xs bg-teal-400 text-white px-1.5 py-0.5 rounded-full font-bold">
                -25%
              </span>
            </button>
          </div>
        ...
        <div ref={ref} className="grid md:grid-cols-3 gap-6 items-stretch">
          {plans.map((plan, i) => (
            ...
            >
              ...
              <div className="mb-7">
                <p
                  className={`text-sm font-bold mb-2 ${plan.highlight ? "text-brand-200" : "text-gray-500"}`}
                >
                  {plan.name}
                </p>
                <div className="flex items-end gap-1 mb-2">
                  ...
                  {plan.price > 0 && (
                    <span
                      className={`text-sm pb-2 ${plan.highlight ? "text-brand-300" : "text-gray-400"}`}
                    >
                      /mo
                    </span>
                  )}
                  ...
                  <li key={f} className="flex items-center gap-3 text-sm">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke={plan.highlight ? "white" : "#534ab7"}
                        strokeWidth="3.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      >
        ...
        <p className="text-center text-sm text-gray-400 mt-8">
          All plans include a 14-day satisfaction guarantee. No credit card
  ...
  const partners = [
    {
      ...
      type: "Partner",
      icon: "🏗️",
      desc: "Career development platform",
    },
    {
      name: "HireReady",
      type: "Partner",
      icon: "🎓",
      desc: "Job readiness bootcamp",
    },
    {
      name: "CareerBridge",
      type: "Partner",
    ...
    <section id="partners" className="py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            We partner with platforms that share our mission, giving job seekers
            a genuine, lasting advantage.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-brand-50 to-teal-50 border border-brand-100 rounded-3xl p-10 lg:p-14 text-center">
          ...
          <p className="text-gray-500 text-sm max-w-lg mx-auto mb-7">
            Whether you're a career platform, bootcamp, recruiter, or employer,
            we'd love to explore how we can work together to help more people
  ...
  const contacts = [
    {
      ...
      label: "Email",
      value: "hello@seevv.io",
      tip: "We reply within 24 hours",
    },
    {
      icon: (
        <svg
      ...
      tip: "Built & headquartered in the UK 🇬🇧",
    },
    {
      icon: (
        <svg
    ...
    <section id="contact" className="py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            Questions, partnerships, feedback, we're all ears. Drop us a message
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            {/* Email + Location — 2-column grid */}
            <div className="grid grid-cols-2 gap-3">
              {contacts.slice(0, 2).map((c) => (
                <div
                  key={c.label}
                  className="group flex flex-col gap-3 p-5 bg-gradient-to-br from-white to-brand-50/40 rounded-2xl border border-brand-100/60 hover:border-brand-200 hover:shadow-md hover:from-brand-50 hover:to-teal-50/30 transition-all duration-300 cursor-default"
                >
                  <div className="w-10 h-10 bg-white border border-brand-100 rounded-xl flex items-center justify-center shadow-sm group-hover:border-brand-200 transition-colors duration-300">
                    {c.icon}
                  </div>
                  <div>
            ...
            {/* Follow us */}
            <div className="p-5 bg-gradient-to-br from-white to-brand-50/30 rounded-2xl border border-brand-100/60">
                ...
                {[
                  {
                    label: "Twitter / X",
                    symbol: "𝕏",
                    tip: "Follow for product updates",
                  ...
                  },
                  {
                    label: "GitHub",
                    symbol: "⌥",
                    tip: "Open source contributions",
                    bg: "bg-brand-600 hover:bg-brand-800",
                  },
                ].map((s) => (
                  <Tooltip key={s.label} text={s.tip} position="top">
                    <button
                      className={`w-11 h-11 ${s.bg} rounded-xl flex items-center justify-center text-sm font-bold text-white transition-all hover:-translate-y-0.5 hover:shadow-lg cursor-pointer`}
                      title={s.label}
                    >
                      {s.symbol}
                    </button>
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full py-4 bg-brand-600 text-white font-bold rounded-2xl hover:bg-brand-800 transition-all hover:-translate-y-0.5 hover:shadow-lg text-sm disabled:opacity-60 disabled:cursor-not-allowed disabled:translate-y-0"
                >
    ...
    <footer className="bg-brand-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-5 gap-10 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              {["𝕏", "in", "⌥"].map((icon, i) => (
                <button
                  key={i}
                  className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-sm font-bold text-white hover:bg-brand-600 transition-colors cursor-pointer"
                >
                  {icon}
                </button>
              ))}
          ...
          {cols.map((col) => (
            <div key={col.title}>
              <p className="text-xs font-bold text-brand-300 uppercase tracking-[0.18em] mb-5">
                {col.title}
              </p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-brand-400 text-xs">
            © {year} Seevv. All rights reserved. Built in the UK 🇬🇧
          </p>
...
const CtaStrip = () => {
  ...
  return (
    <section className="py-24 bg-white overflow-hidden relative">
      ...
      >
        <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-5">
          Your next role is one{" "}
          <span className="gradient-text">tailored application</span> away.
        </h2>
        <p className="text-gray-500 text-lg mb-10 max-w-xl mx-auto">
          Join thousands of job seekers who stopped guessing and started
          winning. Start free — no credit card needed.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/signup"
            className="px-10 py-4 bg-brand-600 text-white font-bold rounded-2xl text-base hover:bg-brand-800 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 text-center"
          >
